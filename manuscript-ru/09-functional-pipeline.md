...
![Данные проходят по цепочке разных состояний, на выходе получаем желаемый результат](../images/09-functional-pipeline.png)
...
![Вся валидация происходит на границах, а внутри данные считаются валидными и безопасными](../images/09-bounded-context.png)
