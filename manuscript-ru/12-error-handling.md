...
| Уточнение 🎯                                                                                                                                                                                                                                                                                             |
| :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Typescript позволяет задать для функции тип возвращаемого значения - `never`. Поэтому, чисто технически, мы можем намекнуть через сигнатуру, что функция может выбросить _какую-то_ ошибку. Мы же хотим конкретизировать ошибку через её тип. Именно поэтому `never` не совсем подходит для наших целей. |
