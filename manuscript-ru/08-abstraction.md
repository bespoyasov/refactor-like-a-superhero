...
| В JavaScript мы можем делать объекты неизменяемыми с помощью `Object.freeze`,[^objectfreeze] но зачастую это оверхед. Обычно достаточно _воспринимать_ данные, как с неизменяемые. |
