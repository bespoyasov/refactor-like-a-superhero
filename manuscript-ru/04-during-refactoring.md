...
Кроме этого маленькие шаги позволяют в любой момент «отложить» рефакторинг и переключиться на другую задачу. Если мы работаем с git, то можем использовать «полочки», чтобы сохранять недоделанную работу через `git stash`. Так разработка будет более гибкой и сможет быстрее реагировать на внезапные проблемы и баги.

Результаты маленьких шагов проще проверять и оценивать перед тем, как сделать с ними коммит. Такие проверки помогают отсеивать изменения, которые не относятся к текущей задаче. Например, случайные изменения, вызванные автоматическими инструментами типа форматеров или линтеров.
...
| К слову 👀                                                                                                                                                                                                                                      |
| :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Такое сочетание атомарных коммитов, непрерывной интеграции кода и проверки изменений перед тем, как их закоммитить, ещё называют «тактической» работой с гитом.[^tacticalgit] Мы в следующих главах тоже иногда будем использовать этот термин. |
