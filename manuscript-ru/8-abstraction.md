...
![Объекты и функции на плитке шестигранников, один из них не помещается](../images/8-app-detalization.png)
...
![Уровни детализации вкладываются друг в друга как матрёшки](../images/8-app-fractal.png)
