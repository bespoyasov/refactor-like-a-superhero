...
Анти-коррозионный слой может увеличить сложность кода. Обычно его стоит добавлять в места, где есть подозрение, что могут измениться данные или API: аналитика, логирование, сохранение данных на девайс пользователя и т.д.
