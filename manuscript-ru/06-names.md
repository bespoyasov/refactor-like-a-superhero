...
| К слову 🔬                                                                                                                                                                                                               |
| :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Если влияние переменной можно засечь на «шве», то с экспериментами помогут тесты. Результаты тестов наглядно покажут, как меняется работа кода в зависимости от различных значений этой переменной.                      |
| В остальных случаях оценивать влияние на работу кода, вероятно, придётся вручную. Как вариант, мы можем наблюдать в отладчике, как различные значения отражаются на других переменных и данных, с которыми работает код. |
