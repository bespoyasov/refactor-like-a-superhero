...
| Подробнее 🔬                                                                                                                                  |
| :-------------------------------------------------------------------------------------------------------------------------------------------- |
| Если сущности с непонятными именами влияют на публичный результат работы кода, то в экспериментах могут помочь тесты. В тестах нам будет проще увидеть, как именно меняется результат. В остальных случаях влияние на работу кода, вероятно, придётся исследовать вручную. |
| Эксперименты не дают _гарантий_, что мы поймём смысл названия правильно, но могут подсказать, каких знаний о проекте нам не хватает. |
