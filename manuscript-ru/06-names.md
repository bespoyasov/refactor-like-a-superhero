...
- в крайнем случае провести серию экспериментов, меняя переменную, и смотря, как это влияет на работу кода.

| Подробнее 🔬                                                                                                                                  |
| :-------------------------------------------------------------------------------------------------------------------------------------------- |
| В последнем случае экспериментировать помогают тесты: они нагляднее показывают, к какому результату приводит изменение непонятных переменных. |
...
```js
// Окей, сокращение USD общеизвестное:
const usd = {};

// Может быть окей, если предметная область программы
// связана с математикой, а модуль работает с производными:
const dx = 0.42;

// Не окей, лучше расшифровать:
const ec = 0.6188;
...
| К слову 🎙                                                                                                                                                                                                          |
| :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Сам термин пришёл из методологии _предметно-ориентированного проектирования (Domain-Driver Design, DDD)_.[^ddd] Мне она кажется удобной для описания предметной области, возможно, вам она тоже окажется полезной. |
