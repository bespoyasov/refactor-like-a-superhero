...
| К слову 🔪                                                    |
| :------------------------------------------------------------ |
| Иногда такой процесс двоичного поиска ещё называют бисекцией. |
...
![Ссылочная прозрачность позволяет заменить вызов функции результатом её работы](../images/11-referential-transparency.png)
...
![Получается такой бутерброд: эффект для получения данных; логика без эффектов; эффект для сохранения данных](../images/11-impureim.png)
