...
We can also count them by changing the conditions of a task and see _which code will change because of it_. For example, if we add a checkbox to the form, the data extraction code will change:
